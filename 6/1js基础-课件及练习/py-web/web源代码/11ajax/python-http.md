#python web  ajax
	...
	Python 和 Ajax2015-10-28
	https://picasso250.github.io/2015/10/28/python-ajax.html



	http://blog.csdn.net/testcs_dn/article/details/50449048
	用Python建立最简单的web服务器
...
##  python 解析http post传递的数据（FieldStorage类 如何 解析http body中json数据）
	http://blog.csdn.net/u014489596/article/details/44959699
