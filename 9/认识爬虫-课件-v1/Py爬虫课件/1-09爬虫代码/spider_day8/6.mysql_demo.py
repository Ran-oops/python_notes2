...
try:
    conn = pymysql.connect('127.0.0.1','root','123456','temp',charset='utf8',cursorclass=pymysql.cursors.DictCursor)
    cursor = conn.cursor()
...
# sql = 'update tencent_job set job_number=127 where id=9'

# 执行增删改
# try:
#     res = cursor.execute(sql,("蓝翔",10,"2018-09-16")) # 返回影响行数
#     conn.commit()
#     print(res)
# except Exception as e:
#     conn.rollback()
